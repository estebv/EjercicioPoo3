...
public class Calculadora {
    ...
    public String potencia() {
        ...
        double potencia = Math.pow(random, 2);
    ...
    public Calculadora() {
        ...
        ModeloCalculadora modelCalculadora = new ModeloCalculadora();
        modelCalculadora.setNumeroDos(random.nextInt(100));
        modelCalculadora.setNumeroUno(random.nextInt(100));
        ...
        System.out.println("la division aleatoria es :" + division(modelCalculadora));
    }
    ...
    public Calculadora(int num1, int num2, int num3, int num4, int num5) {
        ...
        divisioncalculadora.setNumeroUno(num1);
        divisioncalculadora.setNumeroDos(num2);
